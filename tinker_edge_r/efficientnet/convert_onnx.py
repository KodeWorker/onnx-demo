...
RKNN_MODEL = 'opt-efficientnet-b1.rknn'
...
if __name__ == '__main__':
    ...
    if ret != 0:
        print('Load opt-efficientnet-b1 failed!')
        exit(ret)
    print('done')
    ...
    if ret != 0:
        print('Build opt-efficientnet-b1 failed!')
        exit(ret)
    print('done')
    ...
    if ret != 0:
        print('Export opt-efficientnet-b1.rknn failed!')
        exit(ret)
    print('done')
